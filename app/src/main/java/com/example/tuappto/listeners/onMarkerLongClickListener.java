package com.example.tuappto.listeners;
...
public abstract class onMarkerLongClickListener implements GoogleMap.OnMarkerDragListener {
    ...
    public onMarkerLongClickListener(List<Marker> markerList){
